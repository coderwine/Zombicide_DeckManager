...
public class GreenHorde : ICard
{
    public GreenHorde(int id, EnemieActivation blueAtk, int blueCt, EnemieActivation yellowAtk, int yellowCt, EnemieActivation orangeAtk, int orangeCt, EnemieActivation redAtk, int redCt, CardType type)
    {
        CardID = id;
        BlueAttack = blueAtk;
    ...
    public BoxSet Box { get; private set; } = BoxSet.Green_Horde;
}
