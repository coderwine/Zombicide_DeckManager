...
{
    public NoRestForTheWicked(int id, EnemyActivation blueAtk, int blueCt, EnemyActivation yellowAtk, int yellowCt, EnemyActivation orangeAtk, int orangeCt, EnemyActivation redAtk, int redCt, CardType type)
    {
        CardID = id;
        BlueAttack = blueAtk;
